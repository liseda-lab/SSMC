...
- __Similarity Settings__ - Contains the ids of the semantic measures to be used (check table below). Measure arguments include a pairwise measure and an IC measure. Unecessary arguments will be safely ignored. Make sure to use the polar versions when you have polar annotations (with a "+" or "-"), and normal versions when using conventional annotations instead. If you only have positive annotations, it is advisable to convert them to conventional annotations, and apply the normal measures instead.
